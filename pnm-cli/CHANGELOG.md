...
## [0.12.0](https://github.com/robert-affinidi/verifiable-trust-infrastructure/compare/pnm-cli-v0.11.22...pnm-cli-v0.12.0) — 2026-08-12


### Fixed

- **provisioning**: Relay the holder's bootstrap VP as raw JSON ([#949](https://github.com/robert-affinidi/verifiable-trust-infrastructure/pull/949))
