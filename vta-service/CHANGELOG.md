...
## [0.23.4](https://github.com/robert-affinidi/verifiable-trust-infrastructure/compare/vta-service-v0.23.3...vta-service-v0.23.4) — 2026-09-01


### Fixed

- **vta**: Resolve approver sets from one row-first source, not three ([#1221](https://github.com/robert-affinidi/verifiable-trust-infrastructure/pull/1221))
...
- **provisioning**: Say which side is out of date, and check authorization before minting ([#1220](https://github.com/robert-affinidi/verifiable-trust-infrastructure/pull/1220))
...
- **vta**: Keep not-found, conflict and gone typed across the Trust-Task boundary ([#1219](https://github.com/robert-affinidi/verifiable-trust-infrastructure/pull/1219))
...
- **vta**: Scope device list, disable and wipe to the caller's contexts ([#1217](https://github.com/robert-affinidi/verifiable-trust-infrastructure/pull/1217))
